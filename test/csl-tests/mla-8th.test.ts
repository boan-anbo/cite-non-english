/**
 * MLA 8th Edition - CNE variant tests
 *
 * This test suite validates CNE style handling for MLA 8th edition.
 ...
 *
 * Expectations are defined in TypeScript files (e.g., expectations/mla-8th/en-US/chinese.ts)
 */
...
import { chineseExpectations } from './expectations/mla-8th/en-US/chinese';
import { japaneseExpectations } from './expectations/mla-8th/en-US/japanese';
import { koreanExpectations } from './expectations/mla-8th/en-US/korean';
import { englishExpectations } from './expectations/mla-8th/en-US/english';
...
// Style configuration
const STYLE_ID = 'http://www.zotero.org/styles/modern-language-association-8th-cne';
const STYLE_LOCALE = 'en-US';

describe('MLA 8th Edition - CNE (en-US)', function() {
