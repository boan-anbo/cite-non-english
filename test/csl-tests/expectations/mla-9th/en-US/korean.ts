...
export const koreanExpectations: Record<string, string> = {
   ...
   */
  [FIXTURE_IDS.KO_HAN_1991_KYONGHUNG]: `Han T’ae-sik 韓泰植. “Kyŏnghŭng ŭi saengae e kwanhan chae koch’al” 憬興 의 生涯 에 관한 재고찰 [Re-examination of the life of Kyŏnghŭng]. <i>Pulgyo hakpo</i> 佛敎學報, vol. 28, no. 1, 1991, pp. 187–213.`,
   ...
   */
  [FIXTURE_IDS.KO_CHU_2008_KWANGUPYONG]: `Chu Yong-jung 주용중. “Mi sŏ kwangupyŏng palsaeng hamyŏn suip chungdan” 美서 광우병 발생하면 수입 중단 [Will suspend the import if mad cow disease attacks in the United States]. <i>Chosŏn Ilbo</i> 朝鮮日報, 8 May 2008.`,
};
