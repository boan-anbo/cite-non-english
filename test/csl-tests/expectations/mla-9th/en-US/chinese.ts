/**
 * MLA 9th Edition CNE - Chinese Source Expectations
 *
...
export const chineseExpectations: Record<string, string> = {
   ...
   */
  [FIXTURE_IDS.ZHCN_HAO_1998_TANG]: `Hao Chunwen 郝春文. <i>Tang houqi wudai Songchu Dunhuang sengni de shehui shenghuo</i> 唐后期五代宋初敦煌僧尼的社会生活 [The social existence of monks and nuns in Dunhuang during the late Tang, Five Dynasties and early Song]. Zhongguo shehui kexue chubanshe, 1998.`,
   ...
   */
  [FIXTURE_IDS.ZHCN_HUA_1999_QINGDAI]: `Hua Linfu 华林甫. “Qingdai yilai Sanxia diqu shuihan zaihai de chubu yanjiu” 清代以来三峡地区水旱灾害的初步研究 [A preliminary study of floods and droughts in the Three Gorges region since the Qing dynasty]. <i>Zhongguo shehui kexue</i> 中国社会科学, vol. 1, 1999, pp. 168–79.`,

  /**
   * Chinese Database - Beijing Airusheng (2011)
   *
   * MLA Format:
   * Organization. “Title Romanized“ Original [Translation]. Publisher, Year. Database. Web.
   */
  [FIXTURE_IDS.ZHCN_BEIJING_AIRUSHENG_2011]: `Beijing Airusheng shuzihua jishu yanjiu zhongxin 北京爱如生数字化技术研究中心. “Zhongguo jiben guji ku” 中国基本古籍库 [Database of Chinese Classic Ancient Books]. Beijing Airusheng shuzihua jishu yanjiu zhongxin, 2011, <a href="http://server.wenzibase.com/dblist.jsp">http://server.wenzibase.com/dblist.jsp</a>.`,

  /**
   * Chinese Film - Jia (2010)
   *
   * MLA Format:
   * Title Romanized Original [Translation]. Dir. Director Romanized Original. Distributor, Year. Medium.
   */
  [FIXTURE_IDS.ZHCN_JIA_2010_ERSHISI]: `<i>Ershisi cheng ji</i> 二十四城记 [24 City]. Film. Directed by Jia Zhangke 贾樟柯, Cinema Guild, 2010.`,
   ...
   */
  [FIXTURE_IDS.ZHCN_SHA_2014_SHIKU]: `Sha Wutian 沙武田. “Shiku kaogu kaipi Dunghuangxue yanjiu xinlingyu” 石窟考古开辟敦煌学研究新领域 [Cave archeology to open a new field for Dunhuang studies]. <i>Zhongguo shehui kexuebao</i> 中国社会科学报, 8 Jan. 2014.`,
};
