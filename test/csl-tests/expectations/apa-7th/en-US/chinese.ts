...
export const chineseExpectations: Record<string, string> = {
   ...
   */
  [FIXTURE_IDS.ZHCN_HAO_1998_TANG]: `Hao, C. (1998). <i>Tang houqi wudai Songchu Dunhuang sengni de shehui shenghuo</i> [The social existence of monks and nuns in Dunhuang during the late Tang, Five Dynasties and early Song]. Zhongguo shehui kexue chubanshe.`,
   ...
   */
  [FIXTURE_IDS.ZHCN_HUA_1999_QINGDAI]: `Hua, L. (1999). Qingdai yilai Sanxia diqu shuihan zaihai de chubu yanjiu [A preliminary study of floods and droughts in the Three Gorges region since the Qing dynasty]. <i>Zhongguo shehui kexue</i>, <i>1</i>, 168–179.`,
   ...
   */
  [FIXTURE_IDS.ZHCN_BEIJING_AIRUSHENG_2011]: `Beijing Airusheng shuzihua jishu yanjiu zhongxin. (2011). <i>Zhongguo jiben guji ku</i> [Database of Chinese Classic Ancient Books] [Dataset]. Beijing Airusheng shuzihua jishu yanjiu zhongxin. <a href="http://server.wenzibase.com/dblist.jsp">http://server.wenzibase.com/dblist.jsp</a>`,
   ...
   */
  [FIXTURE_IDS.ZHCN_JIA_2010_ERSHISI]: `Jia, Z. (Director). (2010). <i>Ershisi cheng ji</i> [24 City] [Film]. Cinema Guild.`,
   ...
   */
  [FIXTURE_IDS.ZHCN_SHA_2014_SHIKU]: `Sha, W. (2014, January 8). Shiku kaogu kaipi Dunghuangxue yanjiu xinlingyu [Cave archeology to open a new field for Dunhuang studies]. <i>Zhongguo shehui kexuebao</i>.`,
};
