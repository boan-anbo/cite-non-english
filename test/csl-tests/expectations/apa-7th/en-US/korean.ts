...
export const koreanExpectations: Record<string, string> = {
   ...
   */
  [FIXTURE_IDS.KO_KANG_1990_WONYUNG]: `Kang, U. (1990). <i>Wŏnyung kwa chohwa: Han’guk kodae chogaksa ŭi wŏlli</i> [Synthesis and harmony: Principle of the history of ancient Korean sculpture]. Yŏrhwadang.`,
   ...
   */
  [FIXTURE_IDS.KO_HAN_1991_KYONGHUNG]: `Han, T. (1991). Kyŏnghŭng ŭi saengae e kwanhan chae koch’al [Re-examination of the life of Kyŏnghŭng]. <i>Pulgyo hakpo</i>, <i>28</i>(1), 187–213.`,
   ...
   */
  [FIXTURE_IDS.KO_HA_2000_TONGSAM]: `Ha, I. (2000). Tongsam-dong P’aech’ong chŏnghwa chiyŏk palgul sŏngkwa [Result of the excavation on the shell mounds in Tongsam-dong purification region]. In Han’guk Kogo Hakhoe (Ed.), <i>Kogohak ŭl tonghae pon Kaya</i> [Kaya seen through archaeology] (pp. 111–133). Han’guk Kogo Hakhoe.`,
   ...
   */
  [FIXTURE_IDS.KO_CHU_2008_KWANGUPYONG]: `Chu, Y. (2008, May 8). Mi sŏ kwangupyŏng palsaeng hamyŏn suip chungdan [Will suspend the import if mad cow disease attacks in the United States]. <i>Chosŏn Ilbo</i>.`,
};
