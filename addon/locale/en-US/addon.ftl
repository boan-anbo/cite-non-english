...
pref-japanese-spacing = Enable spacing for Japanese names (family name + space + given name)
pref-japanese-spacing-help = Enable for bibliographic styles that require spacing between family and given names
